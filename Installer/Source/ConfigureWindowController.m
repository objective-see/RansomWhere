...
-(IBAction)fdaIssues:(id)sender
{
    ...
    //details
    alert.informativeText =  @"If 'RansomWhere?' is added and enabled in System Preferenes, but this installer hasn't detected that fact, you may have to manully reboot the system to complete the install!";
