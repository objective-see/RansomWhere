...
-(void)applicationDidFinishLaunching:(NSNotification *)notification
{
    ...
    if(0 == preferences.count)
    {
        ...
        //set main text
        alert.messageText = @"Could Not Connect to the RansomWhere Daemon";
        
        //set informative test
        alert.informativeText = @"Please ensure that the RansomWhere daemon is currently running.";
    ...
    if(YES != [preferences[PREF_GOT_FDA] boolValue])
    {
        ...
        //set main text
        alert.messageText = @"RansomWhere? Not Active!";
        
        //set detailed text
        alert.informativeText = @"Please ensure that the RansomWhere? was granted \"Full Disk Access\" via System Preferences.\r\n\r\nIf it was, a manual reboot may fix the issue.";
...
-(IBAction)quit:(id)sender
{
    ...
    //show alert
    response = showAlert(NSAlertStyleInformational, @"Quit RansomWhere?", @"Ransomware protection will be paused until your next login.", @[@"Quit", @"Cancel"]);
